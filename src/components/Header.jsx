  ...
  return (
    <div className='bg-red-500 relative'>
        <div className="overflow-hidden w-[80%] xl:w-[1200px] lg:w-[1000px] md:w-[700px] sm:w-[600px] mx-auto py-3 flex flex-wrap justify-between">
            ...
            <div id='menu' className='transition-all ml-auto text-white text-center bg-red-500 w-[150px] z-10 top-[102%] right-0 p-4 rounded lg:w-[250px] lg:p-0 lg:flex justify-between items-center gap-3'>
