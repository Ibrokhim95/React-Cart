...
const Cart = () => {
  ...
  return (
    <div className='w-[80%] xl:w-[1200px] lg:w-[1000px] md:w-[700px] sm:w-[600px] mx-auto'>
      <h1 className='text-center text-2xl font-bold my-8'>Cart List</h1>
      {LS.map(item => (
        <div key={item.id} className="mb-[100px] flex flex-col md:flex-row my-2 shadow rounded-lg overflow-hidden">
